...
public class ExcelFileRead {
	public static void main(String[] args) throws Exception {
		...
		// set file path
		File src1 = new File("C:\\Demo\\BookRead.xlsx");

		// load the file
		FileInputStream input = new FileInputStream(src1);
		...
		sheet.getRow(1).getCell(0).setCellValue("pune12@gmail.com");
		// no of rows
		...
		for (int i = 0; i < rows; i++) {
			System.out.println("Inside for loop");
				...
				System.out.println("Inside for loop- 5");
				login.click();
				Thread.sleep(10000);
